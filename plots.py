...
#"""
de_file =  "N1024-rho0.85-T1.5-sigMin1.0-sigMax1.0-bulk0-Lz12.0-binwidth0.1-wNeutrality0-density.txt"
de_file2 = "N1024-rho0.85-T1.5-sigMin0.9-sigMax1.1-bulk0-Lz12.0-binwidth0.1-wNeutrality0-density.txt"
de_file3 = "N1024-rho0.85-T1.5-sigMin0.8-sigMax1.2-bulk0-Lz12.0-binwidth0.1-wNeutrality0-density.txt"
de_file4 = "N1024-rho0.85-T1.5-sigMin0.7-sigMax1.3-bulk0-Lz12.0-binwidth0.1-wNeutrality0-density.txt"
de_file5 = "N1024-rho0.85-T1.5-sigMin0.6-sigMax1.4-bulk0-Lz12.0-binwidth0.1-wNeutrality0-density.txt"
de_file6 = "N1024-rho0.85-T1.5-sigMin0.5-sigMax1.5-bulk0-Lz12.0-binwidth0.1-wNeutrality0-density.txt"
de_file7 = "N1024-rho0.85-T1.5-sigMin0.4-sigMax1.6-bulk0-Lz12.0-binwidth0.1-wNeutrality0-density.txt"
data = pd.read_csv(de_file, sep='\s+',header=None, skiprows=1)
data2 = pd.read_csv(de_file2, sep='\s+',header=None, skiprows=1)
data3 = pd.read_csv(de_file3, sep='\s+',header=None, skiprows=1)
data4 = pd.read_csv(de_file4, sep='\s+',header=None, skiprows=1)
...
de_file3 =  "N1024-rho0.83-T1.5-sigMin0.8-sigMax1.2-bulk0-Lz12.0-binwidth0.1-wNeutrality0-energy.txt"
de_file4 =  "N1024-rho0.79-T1.5-sigMin0.7-sigMax1.3-bulk0-Lz12.0-binwidth0.1-wNeutrality0-energy.txt"
de_file5 =  "N1024-rho0.74-T1.5-sigMin0.6-sigMax1.4-bulk0-Lz12.0-binwidth0.1-wNeutrality0-energy.txt"
de_file6 =  "N1024-rho0.69-T1.5-sigMin0.5-sigMax1.5-bulk0-Lz12.0-binwidth0.1-wNeutrality0-energy.txt"
de_file7 =  "N1024-rho0.63-T1.5-sigMin0.4-sigMax1.6-bulk0-Lz12.0-binwidth0.1-wNeutrality0-energy.txt"
...
de_file10 = "N2048-rho0.83-T1.5-sigMin0.8-sigMax1.2-bulk0-Lz12.0-binwidth0.1-wNeutrality0-energy.txt"
de_file11 = "N2048-rho0.79-T1.5-sigMin0.7-sigMax1.3-bulk0-Lz12.0-binwidth0.1-wNeutrality0-energy.txt"
de_file12 = "N2048-rho0.74-T1.5-sigMin0.6-sigMax1.4-bulk0-Lz12.0-binwidth0.1-wNeutrality0-energy.txt"
de_file13 = "N2048-rho0.69-T1.5-sigMin0.5-sigMax1.5-bulk0-Lz12.0-binwidth0.1-wNeutrality0-energy.txt"
de_file14 = "N2048-rho0.63-T1.5-sigMin0.4-sigMax1.6-bulk0-Lz12.0-binwidth0.1-wNeutrality0-energy.txt"
#data = pd.read_csv(de_file, sep='\s+',header=None, skiprows=1)
data2 = pd.read_csv(de_file2, sep='\s+',header=None, skiprows=1)
data3 = pd.read_csv(de_file3, sep='\s+',header=None, skiprows=1)
data4 = pd.read_csv(de_file4, sep='\s+',header=None, skiprows=1)
...
plt.xlabel("Time Steps")
plt.ylabel("Potential Energy")
plt.title("N = 1024 & 2048, T = 1.5, Packing Fractions Densities, Wall Neutrality = 0")
leg = plt.legend();
plt.show()
"""
