...
de_file4 = "N2048-rho0.85-T1.5-sigMin0.7-sigMax1.3-bulk0-Lz12.0-binwidth0.1-wNeutrality1-density.txt"
de_file5 = "N2048-rho0.85-T1.5-sigMin0.6-sigMax1.4-bulk0-Lz12.0-binwidth0.1-wNeutrality1-density.txt"
de_file6 = "N2048-rho0.85-T1.5-sigMin0.5-sigMax1.5-bulk0-Lz12.0-binwidth0.1-wNeutrality1-density.txt"
de_file7 = "N2048-rho0.85-T1.5-sigMin0.4-sigMax1.6-bulk0-Lz12.0-binwidth0.1-wNeutrality1-density.txt"
data = pd.read_csv(de_file, sep='\s+',header=None, skiprows=1)
data2 = pd.read_csv(de_file2, sep='\s+',header=None, skiprows=1)
data3 = pd.read_csv(de_file3, sep='\s+',header=None, skiprows=1)
data4 = pd.read_csv(de_file4, sep='\s+',header=None, skiprows=1)
...
plt.xlabel("Time Steps")
plt.ylabel("Potential Energy")
plt.title("N = 1024 & 2048, T = 1.5, Packing Fractions Densities, Wall Neutrality = 1")
leg = plt.legend();
plt.show()
"""